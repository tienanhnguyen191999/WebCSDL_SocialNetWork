...
@WebServlet("/view/uploadPoster")
@MultipartConfig
public class HandleUploadPoster extends HttpServlet {
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// Delete old version
				...
				try {
					...
					rs1.next();
					if ( !(rs1.getString("poster").equals("poster.png")) ) {
						File f = new File("E:\\JavaWeb\\WebCSDL\\WebContent\\view\\images\\user\\" + rs1.getString("poster"));
				...
				try {
					qr = "update user set poster= ? where user_id = ?";
					st = new Dao().con.prepareStatement(qr);
